...
import SoftDrink from "../../UI/everyProduct/SoftDrink.vue";
...
export default {
  ...
  methods: {
    setPath() {
      ...
      this.$store.dispatch("takePaths", ["Beverages", "Soft Drinks"]);
      this.$store.dispatch("takeUrls", ["beverages", "soft-drinks"]);
    },
  },
  created() {
    this.setPath();
