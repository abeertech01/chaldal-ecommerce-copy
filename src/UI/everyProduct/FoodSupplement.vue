<template>
  <div class="food-supplement">
    ...
    <div class="prod-info">
      <div class="name">{{ foodSupple.name }}</div>
      <div class="info">
        <p class="quantity">{{ foodSupple.quantity }}</p>
        <p class="price">{{ foodSupple.price }}</p>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      product: {
        imgName: this.foodSupple.imgName,
        name: this.foodSupple.name,
